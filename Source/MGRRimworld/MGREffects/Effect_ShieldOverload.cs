...
namespace MGRRimworld
{
    ...
    class Effect_ShieldOverload : Verb_UseAbility
    {
        ...
        {
            this.validTarg = targ.IsValid && targ.CenterVector3.InBounds((((Effect_ShieldOverload)this).CasterPawn).Map) && !targ.Cell.Fogged((((Effect_ShieldOverload)this).CasterPawn).Map) && targ.Cell.Walkable((((Effect_ShieldOverload)this).CasterPawn).Map) && (double)(root - targ.Cell).LengthHorizontal < (double)((Effect_ShieldOverload)this).verbProps.range;
        ...
        protected override bool TryCastShot()
        {
            ...
            if (((Effect_ShieldOverload)this).CasterPawn.equipment.Primary != null && !((Effect_ShieldOverload)this).CasterPawn.equipment.Primary.def.IsRangedWeapon)
            {

                bool flag2;
                if (((Effect_ShieldOverload)this).currentTarget != (LocalTargetInfo)(Thing)null && (((Effect_ShieldOverload)this).CasterPawn) != null)
                {

                    this.arg_29_0 = ((Effect_ShieldOverload)this).currentTarget.Cell;
                    Vector3 centerVector3 = ((Effect_ShieldOverload)this).currentTarget.CenterVector3;
                    flag2 = ((Effect_ShieldOverload)this).currentTarget.Cell.IsValid;
                    this.arg_41_0 = centerVector3.InBounds((((Effect_ShieldOverload)this).CasterPawn).Map);
                    this.arg_42_0 = true;
                }
                else
                    flag2 = false;
                    ...
                    if (flag4 & flag5)
                    {
                        ...
                        if (casterPawn.IsColonist)
                        {
                            try
                            {
                                ...
                                ((Effect_ShieldOverload)this).CasterPawn.DeSpawn(DestroyMode.Vanish);
                                this.SearchForTargets(this.arg_29_0, 2f + 0.5f * (float)this.verVal, map, casterPawn);
                                GenSpawn.Spawn((Thing)casterPawn, ((Effect_ShieldOverload)this).currentTarget.Cell, map);
                                ...
                                MGR_MoteMaker.ThrowGenericMote(MGRDefOf.MGRDefOf.MGR_Mote_BladeSweep, ((Effect_ShieldOverload)this).CasterPawn.DrawPos, ((Effect_ShieldOverload)this).CasterPawn.Map, (float)(1.39999997615814 + 0.400000005960464), 0.04f, 0.0f, 0.18f, 1000, 0.0f, 0.0f, (float)Rand.Range(0, 360));
                            }
                            catch
                            {
                                if (!((Effect_ShieldOverload)this).CasterPawn.Spawned)
                                {
              ...
              ((Effect_ShieldOverload)this).burstShotsLeft = 0;
                return flag1;
            }
            Messages.Message((string)"MustHaveMeleeWeapon".Translate((NamedArgument)((Effect_ShieldOverload)this).CasterPawn.LabelCap), MessageTypeDefOf.RejectInput);
            return false;
        }
        ...
        private void DrawBlade(Vector3 center, float magnitude)
        {
            ...
            for (int index = 0; index < 6; ++index)
            {
                ...
                Graphics.DrawMesh(MeshPool.plane10, matrix, Effect_ShieldOverload.bladeMat, 0);
            }
        }
        ...
        public void damageEntities(Pawn victim, BodyPartRecord hitPart, int amt, DamageDef type)
        {
            ...
            DamageInfo dinfo = new DamageInfo(type, (float)amt, this.dmgNum,instigator: ((Thing)((Effect_ShieldOverload)this).CasterPawn), hitPart: hitPart);
